...
def interpolate(x, /, points, mode='linear', *, padding='zeros'):
...
def apply(x, /, trans, grid=None, mode='linear', *, padding='zeros'):
    ...
    return interpolate(x, points, mode, padding=padding)
